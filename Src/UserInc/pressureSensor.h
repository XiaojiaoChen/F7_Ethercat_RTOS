...
HW060GAUGE_DEVICE *HW060PGSA3(SPI_HandleTypeDef *,GPIO_TypeDef *csPort,uint16_t csPin,uint16_t,uint16_t);
void Init_Pressure(PRESSURE_DEVICE *,SPI_HandleTypeDef *,AD_DEVICE *);
